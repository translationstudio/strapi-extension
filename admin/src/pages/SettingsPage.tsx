...
const apiService = {
  async loadLicense(get: Function): Promise<string> {
    try {
        ...
        <Grid.Root>
          ...
          <>
            ...
            <Grid.Item xs={12} style={{ paddingTop: '3em' }}>
              <Typography variant="beta">Authorize translationstudio requests</Typography>
            </Grid.Item>
            <Grid.Item xs={12} style={{ paddingBottom: '1em' }}>
              <Typography variant="charlie">
                When translationstudio connects with this plugin it will use the following access
                key to authorize itself.
              </Typography>
            </Grid.Item>
            <Grid.Item xs={10}>
              <div style={{display: "block", width: "95%"}}>
